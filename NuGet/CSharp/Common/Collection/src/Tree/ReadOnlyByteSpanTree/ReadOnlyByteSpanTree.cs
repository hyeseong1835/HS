...
public partial class ReadOnlyByteSpanTree<TValue> : IEnumerable<TValue>
{
    ...
    internal struct NodeIterator : IDisposable
    {
        ...
        {
            this.nodeFindIndexTrace = new UnmanagedStack<int>();
        ...
        public bool MoveNext()
        {
            ...
            {
                ref int nodeFindIndex = ref nodeFindIndexTrace.PeekRef();
            ...
            while(true)
            {
                ...
                ref int findNodeIndex = ref nodeFindIndexTrace.PeekRef();
    ...
    IEnumerator<TValue> IEnumerable<TValue>.GetValueEnumerator()
        => new ValueIterator(this);
